...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <cfset alertMessage = getDueDateAlert(dueDate=dt_task_due_date)>
                <cfif alertMessage NEQ "">
                    ...
                    <span class="alert alert-warning text-danger ms-auto mb-2" >
                        #alertMessage#
                    </span>
                </cfif>
                </div>
    ...
    <div class=" d-flex align-items-center card-text"><strong>Due Date:</strong> #DateFormat(dt_task_due_date, "mm/dd/yyyy")#
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="../admin/workedtime.cfm" method="post">
            <input type="text" id="modalTaskId" name="int_task_id" value="">
            <input type="text" id="modalUserId" name="int_user_id" value="">
